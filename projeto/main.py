...
class Bird(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.images = [pygame.image.load('bird2.png').convert_alpha(),
...
class Pipe(pygame.sprite.Sprite):
    ...
    def __init__(self, inverted, xpos, ysize):
        ...
        self.image = pygame.transform.scale(self.image, (PIPE__WIDTH, PIPE_HEIGHT))
...
while True:
    ...
    if is_off_screen(ground_group.sprites()[0]):
        ...
        new_ground = Ground(GROUND_WIDTH - 410)
